...
#ifndef ATMELSAMD21_CLOCK_STUFF_H
#define ATMELSAMD21_CLOCK_STUFF_H
...
void Clock_Init(void) {
    ...
    GCLK->GENDIV.reg |= GCLK_GENDIV_DIV(1) | GCLK_GENDIV_ID(1); //set divide factor for gen clock 1
    ...
    GCLK->GENCTRL.bit.ID = 1;	// This was created in Definitions.h, refers to generic clock 1
...
#endif //ATMELSAMD21_CLOCK_STUFF_H
