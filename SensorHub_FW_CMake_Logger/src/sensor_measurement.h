...
UniversalSensor* UniversalSensorPool[4] = {&compressionSensor, &ventilationSensor, &compressionPositionSensor,
                                           &positioningSensor};
...
void Sensx_hypervisor(void* pvArg) {
  ...
  TimerHandle_t SensbTimer = xTimerCreateStatic("Sensb_timr", DEFAULT_SAMPLE_RATE / portTICK_PERIOD_MS, pdTRUE,
                                                (void*)1, Sensx_timer, &SensTimerBuffers[1]);
